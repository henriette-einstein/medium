...
In the realm of digital organization and note-taking, I recently stumbled upon a post by PKM Beth that sparked my curiosity. Her beautiful page layout in Capacities left me wondering whether I could replicate this aesthetics and functionality within Obsidian? 

As I delved into the visual details Beth shared, I identified three distinct elements that make up her page design:
...
For the banners I tried to get some images of a modern office with less saturated colors also in 16:9 format. Here some more retries were necessary until I got the images I needed.

To add my personal touch to the banner images, I aimed for a modern office aesthetic with muted colors also in the 16:9 ratio. Here, some more retries were necessary until I got the images I wanted.

## Implementing a Captivating Banner Image

To implement a banner image, I used **TfT Hacker's** CSS snippet for Obsidian that creates Notion-like banner images without plugins. It can be found here:

[Hacking Obsidian: Creating Notion-like banner images in Obsidian without Plugins | by TfTHacker | Obsidian Observer | Medium](https://medium.com/obsidian-observer/hacking-obsidian-creating-notion-like-banner-images-in-obsidian-without-plugins-7ad3e0bddc30), 
...
If the image used for the banner is higher than the configured banner-height, the CSS snippet always displays the center part of the banner image. Sometimes I want to display a part of the image above or below the center position. I therefore added a small snippet **banner-pos.css** that allows to set the starting y-position of the image.
...
- **pr-30** states that the right side containing the image shall take up 30% of the whole callout. The content then takes 70%.
- **Hourglass8.png** is the image I want to embed and place on the right side
- **Details** is an embedded note that is rendered in the content area. The content can also be written directly into the callout body, but I prefer a separate note.
